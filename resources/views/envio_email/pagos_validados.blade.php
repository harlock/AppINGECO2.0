...
<head>
    ...
    <title>Comprobante de Pago Validado</title>
    ...
    <style>
        ...
        .header {
            background: linear-gradient(135deg, #198754, #136c43);
            color: #ffffff;
            padding: 25px;
            text-align: center;
        }
...
<div class="email-wrapper">
    ...
    <div class="header">
        ...
        <h1>Comprobante de Pago Validado</h1>
    </div>
    ...
    <div class="content">
        <div class="info-card">
            <div class="info-item">
                ...
                <span><strong>Artículo:</strong> {{ $titulo }}</span>
            </div>
            <div class="info-item">
                <i class="bi bi-check-circle"></i>
                <span><strong>Estado del Pago:</strong> Validado</span>
            </div>
            <div class="info-item">
