    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left">
                    <h2 style="color: #00b4d9; text-align: center">EDITAR MESA MESA EXISTENTE</h2>
                </div>
        ...
        <form action="{{url('mesas', $mesa->id_mesa)}}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="descripcion" value="{{$mesa->descripcion}}" class="form-control" placeholder="Escriba la descripción de la mesa asignada">
