            ...
            <ul class="navbar-nav ms-auto">
                ...
                @auth
                    ...
                    @if(Auth::user()->user_type == 3)
                        ...
                        <!-- Nuevo botón para la vista separada -->
                        <li class="nav-item">
                            <a href="{{ route('actualizar_archivos') }}" class="nav-link">Actualizar Archivos</a>
                        </li>
                    @endif
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item d-flex justify-content-center" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                {{ __('Salir') }}
                            </a>
